...
define('framework/forms/services/toolbar-service',["require", "exports", "tslib", "aurelia-framework", "../../base/services/export", "../services/command-service", "../../dx/services/dx-template-service", "text!../templates/toolbar-button-template.html"], function (require, exports, tslib_1, aurelia_framework_1, export_1, command_service_1, dx_template_service_1, toolbarButtonTemplate) {
    ...
    var ToolbarService = (function () {
        ...
        ToolbarService.prototype.createToolbarOptions = function (bindingContext, expressionProvider, title, commands, componentCreatedCallback) {
            ...
            var items = commands
                .map(function (i) { return _this.createToolbarItem(bindingContext, expressionProvider, function () { return component; }, i); });
            var titleItem = {
        ...
        ToolbarService.prototype.createToolbarItem = function (bindingContext, expressionProvider, getToolbar, command) {
            var _this = this;
            var item = {};
...
define('framework/forms/services/default-commands-service',["require", "exports", "tslib", "aurelia-framework", "../../base/services/export", "../../stack-router/services/router-service"], function (require, exports, tslib_1, aurelia_framework_1, export_1, router_service_1) {
    "use strict";
...
define('framework/forms/classes/edit-popups',["require", "exports", "tslib", "aurelia-framework", "../services/toolbar-service", "../widget-services/simple-widget-creator-service"], function (require, exports, tslib_1, aurelia_framework_1, toolbar_service_1, simple_widget_creator_service_1) {
    "use strict";
    var EditPopups = (function () {
        function EditPopups(simpleWidgetCreator, toolbar) {
        ...
        EditPopups.prototype.addInfo = function (editPopup) {
            ...
            this.form.expressions.createObserver(editPopup.idContent, function (newValue) {
                var popup = _this.form[editPopup.id].instance;
                popup.option("toolbarItems", _this.toolbar.createFormToolbarOptions(newValue).items);
            });
        ...
        EditPopups.prototype.show = function (id) {
            ...
            this.form[editPopup.id].instance.show();
        };
...
define('framework/forms/classes/export',["require", "exports", "./command-server-data", "./commands", "./edit-popups", "./expressions", "./form-base", "./functions", "./models", "./nested-forms", "./variables"], function (require, exports, command_server_data_1, commands_1, edit_popups_1, expressions_1, form_base_1, functions_1, models_1, nested_forms_1, variables_1) {
    "use strict";
